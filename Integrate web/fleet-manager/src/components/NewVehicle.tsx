...
function NewVehicle(props: NewDriverProps) {
  ...
  const handleAddVehicle = () => {
    ...
    if (checkValidation()) {
      ...
      axios
        .post("http://localhost:3000/api/v1/vehicle", vehicle)
        .then((response) => {
  ...
  const handleUpdateVehicle = () => {
    ...
    if (checkValidation()) {
      ...
      axios
        .put(`http://localhost:3000/api/v1/vehicle/${id}`, vehicle)
        .then((response) => {
